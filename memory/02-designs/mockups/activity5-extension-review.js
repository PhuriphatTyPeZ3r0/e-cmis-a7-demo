(function initializeActivity5ExtensionReview(root) {
  ...
  function renderDecisionForm(model) {
    ...
    return `<section class="a5-extension-review-decision" aria-labelledby="a5ExtensionReviewDecisionTitle">
      ...
      <div class="ws-field"><label for="a5ExtensionApprovedDays">จำนวนวันที่อนุมัติ</label><input id="a5ExtensionApprovedDays" type="number" min="1" value="${escapeHtml(model.submittedSnapshot?.payload?.deadline?.requestedDays || "")}"></div>
